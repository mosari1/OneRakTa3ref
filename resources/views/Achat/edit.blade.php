...
@section('content')
    ...
    'route' => ['Achat.update', $achats->id]
                        ...
                        <table class="table" id="maintable">
                            ...
                            <tbody id="tbody">
                            @foreach($achats->produit as $pro)
                            <tr id="trtaa3h">
                                <td>
                                    <input name="id[]" value="{{$pro->id}}" hidden>
                                </td>
                                <td>
                                    <button name="btn" class="delete btn btn-dafault btn-sm" value="Delete">
                                        <span class="glyphicon glyphicon-remove"></span>
                                    </button>
                                </td>
                                <td>
                                    <input class="form-control input-sm" value="{{$pro->code_barre}}">
                                </td>
                                <td class="cart-product-quantity col-xs-2">
                                    <div class="input-group col-xs-2">
                                        <span class="input-group-btn">
                                            <input type="text" id="quantity" name="quantite[]" value="{{$pro->pivot->qte}}" class="qty form-control input-sm"/>
                                            <a name="btn" class="minus btn btn-dafault btn-sm" value="Delete" onclick="minus(this)">
                                                <span class="glyphicon glyphicon-minus"></span>
                                            </a>
                                            <a name="btn" class="plus btn btn-dafault btn-sm" value="Delete" onclick="plus(this)">
                                                <span class="glyphicon glyphicon-plus"></span>
                                            </a></span>
                                    </div>
                                </td>
                                <td class="cart-product-price">
                                    <span id="price" class="amount">{{$pro->prix_achat}}</span>
                                </td>
                                <td class="cart-product-subtotal">
                                    <span id="total_amount" class="total_amount"></span>
                                </td>
                                <td>
                                    <input type="text" class="form-control input-sm" disabled value="17">
                                </td>
                                <td>
                                    <span id="total_amount_ttc" class="total_amount_ttc"></span>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
                            ...
                            <tr>
                                ...
                                <td><span id="total-ht" class="total-ht">{{$achats->total_ht}}</span>
                            ...
                            <tr>
                                ...
                                <td><span id="total-ttc" class="total-ttc" >{{$achats->total_ttc}}</span></td>
