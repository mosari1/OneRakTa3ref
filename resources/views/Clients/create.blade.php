                    ...
                    <div data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="code" name="code" required="required" class="form-control col-md-7 col-xs-12 " data-parsley-id="5"><ul class="parsley-errors-list filled" id="parsley-id-5"></ul>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nom" name="nom" required="required" class="form-control col-md-7 col-xs-12" data-parsley-id="7"><ul class="parsley-errors-list filled" id="parsley-id-7"><li class="parsley-required"></li></ul>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="libelle" class="form-control col-md-7 col-xs-12" type="text" name="prenom" data-parsley-id="9">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="tel" class="form-control col-md-7 col-xs-12" type="text" name="tel" data-parsley-id="9">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="quantite" name="email" class="date-picker form-control col-md-7 col-xs-12 " required="required" type="text" data-parsley-id="16"><ul class="parsley-errors-list filled" id="parsley-id-16"><li class="parsley-required"></li></ul>
