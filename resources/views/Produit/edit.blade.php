...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    {!! Form::model($produit, [
    'method' => 'PATCH',
    'route' => ['Produit.update', $produit->id]
]) !!}
                    ...
                    <div data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" value="{{$produit->code_barre}}" id="code_barre" name="code_barre" required="required" class="form-control col-md-7 col-xs-12 " data-parsley-id="5"><ul class="parsley-errors-list filled" id="parsley-id-5"></ul>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" value="{{$produit->code}}"  id="code" name="code" required="required" class="form-control col-md-7 col-xs-12" data-parsley-id="7"><ul class="parsley-errors-list filled" id="parsley-id-7"><li class="parsley-required"></li></ul>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="libelle" value="{{$produit->libelle}}" class="form-control col-md-7 col-xs-12" type="text" name="libelle" data-parsley-id="9">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="type_id" class="form-control col-md-7 col-xs-12" type="select" name="type_id" data-parsley-id="9">
                            @if($produit->type)
                             <option value="{{$produit->type->id}}" selected>{{$produit->type->type}}</option>
                            @endif
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="quantite" value="{{$produit->quantite}}" name="quantite" class="date-picker form-control col-md-7 col-xs-12 " required="required" type="text" data-parsley-id="16"><ul class="parsley-errors-list filled" id="parsley-id-16"><li class="parsley-required"></li></ul>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="prix_achat" value="{{$produit->prix_achat}}" name="prix_achat" class="date-picker form-control col-md-7 col-xs-12 " required="required" type="text" data-parsley-id="16"><ul class="parsley-errors-list filled" id="parsley-id-16"><li class="parsley-required"></li></ul>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="prix_vente" value="{{$produit->prix_vente}}" name="prix_vente" class="date-picker form-control col-md-7 col-xs-12 " required="required" type="text" data-parsley-id="16"><ul class="parsley-errors-list filled" id="parsley-id-16"><li class="parsley-required"></li></ul>
