...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <!-- start accordion -->
        @if(Session::has('ajout_fournisseur'))
            <div class="alert alert-success alert-dismissible fade in" role="alert">
                <button href="#" class="close" data-dismiss="alert" aria-label="close">&times;</button>
                <strong>{!! session('ajout_fournisseur') !!}</strong>
            </div>
        @endif
        <div class="accordion">
            <div class="panel">
                ...
                <div class="panel-body">
                    {!! Form::open(array('url' => 'Fournisseur.Validation')) !!}
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="rc" placeholder="Numero registre de commerce" >
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="nis" placeholder="Numero d'identifiant social" >
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="rib" placeholder="Numero d'identifiant social" >
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="ai" placeholder="Numero d'identifiant social" >
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="nif" placeholder="Numero d'identifiant fiscale" >
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
